...
describe('Module require extension integration - synchronous mode', function () {
    beforeEach(function () {
    ...
    describe('after installing the require(...) extension', function () {
        ...
        it('should correctly require a PHP module that just returns 21', function () {
            ...
            expect(this.module.exports().execute().getNative()).to.equal(21);
        });
        ...
        it('should correctly require a PHP module that includes another', function () {
            ...
            expect(this.module.exports().execute().getNative()).to.equal(1021);
        });
    });
});
